 ...
 *     });
 *
 */(function(e,t){typeof define=="function"&&define.amd?define([],t):typeof module=="object"&&module.exports?module.exports=t():e.sanidate=t()})(this,function(){function r(e){var t=/\d+/g,n="";while(match=t.exec(e))n+=match[0];return n}function i(e){return e=r(e),"("+e.slice(0,3)+") "+e.slice(3,6)+"-"+e.slice(6)}var e={},t=/^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/,n=/^\(?\d{3}\)? ?\d{3}-?\d{4}$/;return e.funcs={none:function(){return function(e,t){t(null,e)}},required:function(){return function(e,t){t(null,e?e:null,"required")}},match:function(e){return function(t,n){n(null,e.exec(t)?t:null,"match")}},numeric:function(){return function(e,t){var n=parseFloat(e);t(null,isNaN(n)?null:n,"numeric")}},integer:function(){return function(e,t){var n=parseInt(e,10);t(null,isNaN(n)?null:n,"integer")}},min:function(e,t){return function(n,r){var i=t?parseInt(n,10):parseFloat(n);r(null,!isNaN(i)&&i>e?i:null,"min")}},max:function(e,t){return function(n,r){var i=t?parseInt(n,10):parseFloat(n);r(null,!isNaN(i)&&i<=e?i:null,"min")}},date:function(){return function(e,t){var n=new Date(e);t(null,n.toString()!=="Invalid Date"?n:null,"date")}},email:function(){return function(e,n){n(null,t.exec(e)?e:null,"email")}},zip:function(){return function(e,t){t(null,/^\d{5}$/.exec(e)?e:null,"zip")}},isTrue:function(){return function(e,t){t(null,"true yes 1 on".split(" ").indexOf(e)>-1,"isTrue")}},isNotFalse:function(){return function(e,t){t(null,"false no 0 off".split(" ").indexOf(e)<0,"isFalse")}},phone:function(e){return function(t,s){s(null,n.exec(t)?e?r(t):i(t):null,"phone")}},isDocument:function(e,t){return t=t||this.name,function(n,r){var i={};i[t]=n,e.findOne(i,function(e,t){e&&r(e,null,"isDocument"),r(null,t||null,"isDocument")})}},isNotDocument:function(e,t){return t=t||this.name,function(n,r){var i={};i[t]=n,e.findOne(i,function(e,t){e&&r(e,null,"isNotDocument"),r(null,t?null:n,"isNotDocument")})}},custom:function(e){return e},optional:function(e){var t=this.originalValue||e;return function(e,n){n(null,e?e:t,e?"optional":null)}}},e.checkParam=function(t,n,r,i){function o(e,t,n){if(!e.length)return n(null,t);e[0](t,function(t,r,i,s){if(t)return n(t,null,i);if(r===null)return n(null,null,i);if(i===null)return n(null,r);o(e.slice(1),r,n)})}var s={name:t,originalValue:n};typeof r=="string"&&(r=[r]),r=r.map(function(t){var n,r;typeof t=="string"?(n=e.funcs[t],r=[]):(n=e.funcs[t[0]],r=t.slice(1));if(typeof n!="function")throw new Error("Constraint "+t+" is not a function "+"for param "+parameterName);return n.apply(s,r)}),o(r,n,i)},e.check=function(t,n,r){var i={},s={count:0,errors:{}},o=Object.keys(n).length;Object.keys(n).forEach(function(u){e.checkParam(u,t[u],n[u],function(e,t,n){e||t===null?(s.count+=1,s.errors[u]=n):i[u]=t,o--,o||r(s,i)})})},e.express=function(t){return function(n,r,i){n.sanidateFuncs=e.funcs,n.sanidate=e.check;if(t){var s={};Object.keys(t).forEach(function(e){s[e]=n.param(e)}),e.check(s,t,function(e,t){n.data=t,e.count&&(n.dataErrors=e),i()})}else i()}},e.frag=function(t){return function(t){this.sanidateFuncs=e.funcs,this.sanidate=e.check}},e.jQuery=function(t){t.fn.sanidate=function(n,r){var i=t(this),s={};Object.keys(n).forEach(function(e){s[e]=i.find(":input[name="+e+"]").val()}),e.check(s,n,r)}},e});